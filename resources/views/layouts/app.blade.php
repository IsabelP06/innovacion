...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark d-print-none">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <p class="text-white my-auto"> {{ Auth::user()->name }}</p>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ URL::to('dashboard/transportista') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                            Informacion del transportista
                        </a>
                        <a class="nav-link" href="{{ URL::to('/dashboard/registro_conformidad') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-file-pdf"></i></div>
                            Guias de remisión
                        </a>
                        <a class="nav-link" href="{{ URL::to('/dashboard/sedes') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-home"></i></div>
                            Sedes
                        </a>
                        <a class="nav-link" href="{{ URL::to('/dashboard/usuario') }}">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                <a class="nav-link collapsed" href="{{ URL::to("/dashboard/config/correos")}}">
                                    Correos
                        ...
                        <a class="nav-link">
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="d-flex">
                                ...
                                <input type="submit" value="Salir"
                                    style="background:transparent;border:none;color:rgba(255, 255, 255, 0.774)"
                                    class="d-flex  w-100">
                            </form>
                        </a>
                    </div>
