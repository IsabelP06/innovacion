...
<body class="wrap-content-login">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 vh-100 p-relative d-flex justify-content-center align-items-center">
                ...
                <div class="card border-0 p-relative bg-login w-100">
                    ...
                    <div class="card-body">
                        <form method="POST" class="mt-3" action="{{ route('authenticatetransportista') }}">
                            @csrf
